...
void Audio::inputFile()
{
	ifstream file("you_and_i.pcm", std::ios_base::binary);
	while (file.good()) {
...
void Audio::bassCoefficients(int intensity, double* b0, double* b1, double* b2, double* a1, double* a2)
{
...
void Audio::trebleCoefficients(int intensity, double* b0, double* b1, double* b2, double* a1, double* a2)
{
